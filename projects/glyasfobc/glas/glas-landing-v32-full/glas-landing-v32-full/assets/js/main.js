document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(toggle&&mobile){
    ...
    mobile.querySelectorAll('a').forEach(a=>a.addEventListener('click',()=>setMenuState(false)));

    // Cierra el burger al tocar/clickear cualquier zona fuera del menú y del botón.
    ...
    // También permite cerrarlo con Escape.
